                                ...
                                <div className="card z-index-0">
                                    ...
                                    <div className="card-body">
                                        <form role="form" onSubmit={submit} noValidate>
                                            <div className="mb-3">
                                                <input value={data.email} onChange={onHandleChange} type="email" name='email' id='email' className="form-control form-control-lg" placeholder="Email" aria-label="Email" />
                                                {errors && (<div className='text-danger mt-1'>{errors.email}</div>)}
                                            </div>

                                            <div className="mb-3">
                                                <input value={data.password} onChange={onHandleChange} type="password" name='password' id='password' className="form-control form-control-lg" placeholder="Password" aria-label="Password" />
                                                {errors && (<div className='text-danger mt-1'>{errors.password}</div>)}
                                            </div>

                                            <div className="form-check form-switch">
                                                <input value={data.remember} onChange={onHandleChange} name='remember' id='remember' className="form-check-input" type="checkbox" />
                                                <label className="form-check-label" htmlFor="rememberMe">Remember me</label>
                                            </div>

                                            <div className="text-center">
                                                {/* <button type="submit" className="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" processing={processing}>Sign in</button> */}
                                                <Button processing={processing}
                                                    className="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Sign in</Button>
                                            </div>
                                    ...
                                    <div className="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p className="mb-4 text-sm mx-auto">
                                           ...
                                           {/*  <Link href={route('password.request')} className="text-primary text-gradient font-weight-bold">Sign up</Link> */}
                                        </p>
                                    </div>
                                </div>
                            </div>
...
Login.layout = (page) => <Base children={page} title={"Login"}/>